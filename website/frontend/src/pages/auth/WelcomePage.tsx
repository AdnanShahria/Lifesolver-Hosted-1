    ...
    return (
        <main className="min-h-screen bg-background overflow-hidden">
            ...
            <div className="hidden md:flex fixed top-4 left-0 right-0 z-50 justify-center pointer-events-none">
                ...
                >
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                        ...
                        <Link to="/auth/register" reloadDocument className="shrink-0 ml-1">
            ...
            >
                ...
                >
                    <Link to="/auth/register" reloadDocument className="block">
                    ...
                    <Link to="/auth/login" reloadDocument className="block">
