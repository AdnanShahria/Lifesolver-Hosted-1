...
export default function SettingsPage() {
    ...
    const handleThemeChange = (theme: "light" | "dark" | "oled" | "midnight" | "nord" | "mocha") => {
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        >
                            ...
                            <SelectContent>
                                ...
                                <SelectItem value="dark">Cyan Dark (Default)</SelectItem>
                                <SelectItem value="oled">Pure OLED Black</SelectItem>
                                <SelectItem value="midnight">Midnight Purple</SelectItem>
                                <SelectItem value="nord">Nord Arctic</SelectItem>
                                <SelectItem value="mocha">Mocha Warm Dark</SelectItem>
                            </SelectContent>
                        </Select>
                    </div>
                </motion.div>
