                                ...
                                <div className="flex justify-between gap-2">
                                    {otp.map((digit, index) => (
                                        <input
                                            ...
                                            className={`w-12 h-14 text-center text-2xl font-bold rounded-xl border-2 focus:outline-none focus:border-yellow-500 focus:ring-4 focus:ring-yellow-500/20 transition-all duration-300 ${
                                                digit 
